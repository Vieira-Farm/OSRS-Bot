...
import scripts.scripting.swingcomponents.jiconfont.IconCode;
...
import scripts.scripting.swingcomponents.swingmaterialdesign.MaterialShadow;
import scripts.scripting.swingcomponents.panels.wizard.StartButtonPane;
...
public class WizardStartButton extends MaterialButton {
	...
	public WizardStartButton(String text, Color backgroundColor, StartButtonPane.ButtonLayout buttonLayout) {
		this(text, backgroundColor, buttonLayout, null);
	}
	
	public WizardStartButton(String text, Color backgroundColor, StartButtonPane.ButtonLayout buttonLayout, IconCode iconCode) {
		super(text, 600);
