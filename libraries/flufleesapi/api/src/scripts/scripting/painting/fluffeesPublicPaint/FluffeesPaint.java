package scripts.scripting.painting.fluffeesPublicPaint;
...
public class FluffeesPaint {
    ...
    public FluffeesPaint(PaintInfo paintInfo, PaintLocations location, Color[] fontColors, String fontName, Color[] textBackgroundColors, Color[] textBackgroundBorderColors, int borderThickness, boolean singleBackground, int spaceBetweenFields, int horizontalPadding, int verticalPadding) {
        ...
        this.fontName = Arrays.stream(graphicsEnvironment.getAvailableFontFamilyNames()).anyMatch(fontName::equals) ? fontName : graphicsEnvironment.getAvailableFontFamilyNames()[0];
    ...
    /**
     * Method used to create an array of PaintableText types, used for painting text with separate backgrounds.
     *
     * @param graphics - Graphics object.
    ...
    /**
     * Paints the information on the screen by creating the PaintableText types and painting them individually.
     *
     * @param graphics
     */
