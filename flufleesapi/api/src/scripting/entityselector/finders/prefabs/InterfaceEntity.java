package scripting.entityselector.finders.prefabs;
...
import scripting.entityselector.finders.FinderResult;
import scripting.entityselector.finders.Utils;
...
public class InterfaceEntity extends FinderResult<RSInterface> {
     ...
     * @return
     */
    public InterfaceEntity viewportHeightGreaterThan(int minValue) {

        filters.add((rsInterface) -> {

            int viewportHeight = rsInterface.getViewportHeight();

            return minValue < viewportHeight;
        });
